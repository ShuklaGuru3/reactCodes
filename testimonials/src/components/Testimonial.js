...
const Testimonial = (props) => {
  ...
  return (
    <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md'>
      ...
      <div className='mt-9'>
      <button className='bg-violet-400 hover:bg-violet-500 transition-all duratoin-200 cursor-pointer px-10 py-2 rounded-md font-bold text-white text-lg' onClick={surpriseHandler
    }>Surprise Me</button>
      </div>
    </div>
  )
